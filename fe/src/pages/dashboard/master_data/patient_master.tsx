        ...
        <div className={`${styles['children_master']}`}>
          ...
          <div className={styles['table-master-bg']}>
            ...
            <div className='m-6 flex items-center justify-center'>
              <table className='w-[1172px] text-center text-gray-500'>
                  ...
                  {(searchValue == '' ? patients : searchResults).map(
                    (item, index) => (
                      ...
                      >
                        ...
                        <td className='py-4'>{item.patient_name}</td>
                        <td className='py-4'>{item.admission_date}</td>
                        <td className='py-4'>
                          {item.discharge_date != ''
                            ? item.discharge_date
                            : '-'}
                        </td>
                        <td className='py-4'>{item.patient_room}</td>
                        <td className='py-4'>{item.gender}</td>
                        <td className='py-4'>{item.birth}</td>
                        <td className='py-4'>{item.id_card}</td>
                        <td className='py-4'>{item.address}</td>
                        <td className='py-4'>{item.contact}</td>
                        <td className='py-4'>{item.education}</td>
                        <td className='py-4'>{item.occupation}</td>
                        <td className='py-4'>{item.next_of_kin_name}</td>
                        <td className='py-4'>{item.relationship}</td>
                        <td className='py-4'>
